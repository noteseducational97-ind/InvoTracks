...
export default function MutualFundCalculatorPage() {
    ...
    const [results, setResults] = useState<MutualFundResult | null>(null);
    ...
    return (
        <div>
            <h1 className="font-headline text-3xl font-bold tracking-tight">Mutual Fund Calculator</h1>
            <p className="text-muted-foreground">Estimate the future value of your mutual fund investments.</p>

            <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-5">
                <Card className="lg:col-span-3">
                    <CardHeader>
                        <CardTitle className="font-headline">Mutual Fund SIP Details</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <Button onClick={calculateMutualFund} className="w-full">Calculate</Button>
                    </CardContent>
                </Card>
