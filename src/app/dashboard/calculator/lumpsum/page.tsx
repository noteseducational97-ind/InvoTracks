...
export default function LumpsumCalculatorPage() {
    ...
    const calculateLumpsum = () => {
        ...
        const r = annualRate / 100; // annual interest rate
        const n = years;
    ...
    return (
        <div>
            ...
            <p className="text-muted-foreground">Estimate the total value of your one-time investment.</p>

            <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-5">
                <Card className="lg:col-span-3">
                    <CardHeader>
                        <CardTitle className="font-headline">Lumpsum Investment</CardTitle>
